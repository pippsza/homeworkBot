 ...
 */
function generatePointId(infoId, type, index) {
 ...
 * Returns { chunks: string[], embeddings: number[][] }
 */
async function chunkAttachments(attachments) {
 ...
 */
async function syncInfoChunks(infoId) {
 ...
 */
async function deleteInfoChunks(infoId) {
  await qdrantService.deleteGeneralByDocumentId(infoId.toString());
}

module.exports = { syncInfoChunks, deleteInfoChunks };
